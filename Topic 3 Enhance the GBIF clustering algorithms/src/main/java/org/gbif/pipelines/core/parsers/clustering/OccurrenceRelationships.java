...
public class OccurrenceRelationships {
  ...
  private static <T extends OccurrenceFeatures> void compareDates(
    ...
    } else if (allNull(o1.getEventDate(), o1.getDay(), o1.getMonth(), o1.getYear(),
        o2.getEventDate(), o2.getDay(), o2.getMonth(), o2.getYear())) {
  ...
  private static <T extends OccurrenceFeatures> void compareCoordinates(
    ...
    } else if (allNull(o1.getDecimalLatitude(), o1.getDecimalLongitude(), o2.getDecimalLatitude(),
        o2.getDecimalLongitude()) || (presentOnOneOnly(o1.getDecimalLatitude(), o2.getDecimalLatitude())
